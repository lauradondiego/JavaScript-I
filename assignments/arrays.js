...
// console.log(("Car " + inventory.id:33 + " is a " + inventory.car_year + inventory.car_make + inventory.car_model);
// console.log(`Car 33 is a + inventory.id:33.car_year) (inventory.car_make) inventory.car_model` );
